...
**Status:** v6 — **Tier 1 plus cross-process metadata transactions implemented.** Supersedes v5 (and v4, v3, v2, and the v1 "Content-addressed caching for MeasurementSets and FITS images")
